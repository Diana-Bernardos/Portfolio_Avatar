...
export function Contact() {
  return (
    <section id="contact" className="bg-background px-6 py-16 md:px-12 md:py-24">
            ...
            <div className="space-y-6">
              {[
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  <div className="mr-4 rounded-[1rem] border border-borderC bg-[rgb(var(--color-surface))] p-3 text-primary shadow-[0_0_0_rgba(0,0,0,0)] transition-all duration-300 group-hover:-translate-y-1 group-hover:border-accent group-hover:shadow-[0_0_18px_rgba(0,209,255,0.16)]">
                    {item.icon}
                  </div>
                  <div>
                    ...
                    <p className="text-xs font-medium text-secondary transition-colors duration-300 group-hover:text-primary/80">{item.label}</p>
                  </div>
                </motion.a>
              ))}
            </div>
          ...
          >
            <div className="relative flex w-full flex-col space-y-4 text-base">
              ...
              <motion.input
                ...
                className="relative z-10 w-full cursor-text rounded-xl border border-borderC bg-[rgb(var(--color-surface))] px-5 py-4 text-primary transition-all hover:border-accent/70 focus:border-accent focus:outline-none focus:shadow-[0_0_18px_rgba(0,209,255,0.14)]"
              ...
              <motion.textarea
                ...
                className="relative z-10 h-40 w-full resize-none cursor-text rounded-xl border border-borderC bg-[rgb(var(--color-surface))] px-5 py-4 text-primary transition-all hover:border-accent/70 focus:border-accent focus:outline-none focus:shadow-[0_0_18px_rgba(0,209,255,0.14)]"
                whileFocus={{ scale: 1.01 }}
                disabled
              />
